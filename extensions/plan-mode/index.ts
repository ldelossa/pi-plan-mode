    ...
    pi.sendMessage(
      {
        ...
        content: [
          ...
          '',
          'Read the edited HANDOFF.md and tasks.jsonl. Treat my edits as inline review comments, questions, and directives about the plan.',
          '',
          '— Clear directives (e.g. "change step 3 to use X instead of Y"): apply them to the plan and call revise_plan.',
          '— Questions I wrote inline: answer them directly. If answering requires a plan change, update the plan and call revise_plan.',
          '— Ambiguous comments or trade-offs that need my input: do NOT guess. Pause and ask me a clarifying question. Wait for my answer, then revise.',
          '',
          'If nothing substantive changed or my edits are just minor wording tweaks, note that the plan is unchanged and tell me what you observed.',
          '',
          `Existing plan name: "${state.plan!.planName}"`,
          '',
